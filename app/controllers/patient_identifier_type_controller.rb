class PatientIdentifierTypeController < ApplicationController
  ...
  def create
    begin
      @patient_identifier_type = PatientIdentifierType.new(params[:patient_identifier_type])
      @successful = @patient_identifier_type.save
    rescue
  ...
  def edit
    begin
      ...
      @successful = !@patient_identifier_type.nil?
    rescue
      flash[:error], @successful  = $!.to_s, false
    end
  ...
  def update
    begin
      @patient_identifier_type = PatientIdentifierType.find(params[:id])
      @successful = @patient_identifier_type.update_attributes(params[:patient_identifier_type])
    rescue
      flash[:error], @successful  = $!.to_s, false
    end
  ...
  def destroy
    begin
      @successful = PatientIdentifierType.find(params[:id]).destroy
    rescue
      flash[:error], @successful  = $!.to_s, false
    end
