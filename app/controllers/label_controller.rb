...
#  id = params[:id]
  ...
  def new_national_ids_only
    send_data(PatientNationalId.next_ids_available_label(params[:department]),:type=>"application/label; charset=utf-8", :stream=> false, :filename=>"new_#{rand(10000)}.lbl", :disposition => "inline")
  end
