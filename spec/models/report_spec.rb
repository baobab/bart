...
describe Report do
  ...
  it "should generate survival analysis hash" do
    #{""=>5, "Defaulted"=>0, "End Date"=>Sat, 31 Mar 2007, "Start Date"=>Mon, 01 Jan 2007, "Title"=>"12 month survival: outcomes by end of March 2008", "On ART"=>0, "Transfer out"=>0, "Total"=>5, "Died"=>0, "ART Stop"=>0} (using ==)
    PatientHistoricalOutcome.reset

    Report.survival_analysis_hash(Patient.find(:all), '2007-01-01'.to_date, '2007-03-31'.to_date, '2008-03-31'.to_date, 1).should == {"Defaulted"=>2, "End Date"=> '31 Mar 2007'.to_date, "Start Date"=> '01 Jan 2007'.to_date, "Title"=>"12 month survival: outcomes by end of March 2008", "On ART"=>0, "Transfer out"=>0, "Total"=>5, "Died"=>0, "ART Stop"=>0}
  end
  ...
  it "should show table of results in weeks" do
     encounters = Report.user_stat_data("01-01-2007".to_date,Date.today,users(:mikmck).username)
     weeks = Report.stats_to_show(encounters['ART Visit'])
     Report.detail_user_encounter_results_html(weeks,'ART Visit',users(:mikmck).username).should =="<tr><td class='button_td'><input class='test_name' type=\"button\" onmousedown=\"document.location='/reports/user_stats_graph?id=3,0,0,0,0,0,0&date=05-Mar-2007&user_name=mikmck&stat_name=ART Visit';\" value=\"05-Mar-2007 - 11-Mar-2007\"/></td><td class='data_td'> 3</td><td class='data_td'></td><td class='data_td'></td><td class='data_td'></td><td class='data_td'></td><td class='data_td'></td><td class='data_td'></td><td class='data_totals_td'>3</td></tr><tr><td class='button_td'><input class='test_name' type=\"button\" onmousedown=\"document.location='/reports/user_stats_graph?id=1,0,0,0,0,0,0&date=05-Feb-2007&user_name=mikmck&stat_name=ART Visit';\" value=\"05-Feb-2007 - 11-Feb-2007\"/></td><td class='data_td'> 1</td><td class='data_td'></td><td class='data_td'></td><td class='data_td'></td><td class='data_td'></td><td class='data_td'></td><td class='data_td'></td><td class='data_totals_td'>1</td></tr>"
  end
