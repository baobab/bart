...
describe DrugOrder do
  ...
  it "should return the given dosage" do
    ...
    DrugOrder.given_drugs_dosage(drug_orders).should == ["Stavudine 30 Lamivudine 150 Nevirapine 200,Morning,1.0,60", "Stavudine 30 Lamivudine 150 Nevirapine 200,Evening,1.0,60"]
  end
