...
elseif regimen_id = 452 and current_weight < 25 then set category = "3P";                                    
elseif regimen_id = 452 and current_weight >= 25 then set category = "3A";                                    
elseif regimen_id = 458 and current_weight < 25 then set category = "4P";                                    
elseif regimen_id = 458 and current_weight >= 25 then set category = "4A";                                    
